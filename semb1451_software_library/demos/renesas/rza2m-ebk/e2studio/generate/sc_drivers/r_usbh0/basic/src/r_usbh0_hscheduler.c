...
QueueHandle_t *g_usbh0_msg_table[] = {
...
} /* End of function usbh0_hstd_rtos_snd_msg() */
...
//	err = xQueueReceive(handle, (void *)mess, (TickType_t)(tm));  //20190404 CHG for -O3
	while( 0 == xQueueReceive(handle, (void *)mess, (TickType_t)(tm)) ){}
	if ((USBH0_TID_0 == id) && (NULL == (*mess)))
	{
		return USBH0_OK;
	}
