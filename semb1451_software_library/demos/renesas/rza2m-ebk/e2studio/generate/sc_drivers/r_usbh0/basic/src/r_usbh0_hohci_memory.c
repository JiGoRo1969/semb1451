...
void usbh0_hstd_ohci_free_transfer_descriptor(st_usbh0_ohci_hcd_transfer_descriptor_p_t td)
{
    ...
    tmp_usb_drequest = r_usbh0_pa_to_va((uint32_t)td->usb_drequest);
    tmp_hcd_list_f_link = r_usbh0_pa_to_va((uint32_t)tmp_usb_drequest->hcd_list.f_link);
    tmp_hcd_list_b_link = r_usbh0_pa_to_va((uint32_t)tmp_usb_drequest->hcd_list.b_link);
...
//    static struct usbh0_ohci_hcd_transfer_descriptor   *tp;
//    static struct usbh0_ohci_hcd_transfer_descriptor   *tp_next;
