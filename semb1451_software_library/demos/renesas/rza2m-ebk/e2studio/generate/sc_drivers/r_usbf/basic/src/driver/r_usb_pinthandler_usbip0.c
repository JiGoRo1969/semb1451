...
//usb_int_t g_usb_cstd_int[USB_INT_BUFSIZE] __attribute__ ((section ("USB_DATA_RAM"))); //20190819 DEL sawada
...
//    usb_int_t       *p;
//    
//    p = &g_usb_cstd_int[get_usb_int_buf__count];
//    
//    get_usb_int_buf__count = ((count + 1) % USB_INT_BUFSIZE);
//    
//    return p;
//}
/******************************************************************************
