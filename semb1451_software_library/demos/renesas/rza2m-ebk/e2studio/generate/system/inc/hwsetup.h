 ...
 */
extern void Userdef_PreHardwareSetup(void) __attribute__((weak));

/**
 * @fn         Userdef_PostHardwareSetup
 * @brief      User defined hardware setup called later of R_SC_HardwareSetup
 */
extern void Userdef_PostHardwareSetup(void) __attribute__((weak));
 ...
 *             wrapper interface
 */
extern void R_SPIBSC_Setup(void) __attribute__((weak));
 ...
 *             wrapper interface
 */
extern void R_HYPERBUS_Setup(void) __attribute__((weak));
 ...
 *             wrapper interface
 */
extern void R_OCTABUS_Setup(void) __attribute__((weak));
